...
func (self *ircchannel) getUsers() []string {
...
func (self *ircd) disseminate(client *ircclient, msg *ircmessage) {
...
func (self *ircclient) handleMessage(msg *ircmessage) {
    ...
    case "QUIT":
        ...
        self.server.disseminate(self, msg)
        self.Kill()
    default:
